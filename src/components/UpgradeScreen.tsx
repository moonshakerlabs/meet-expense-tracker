...
const UpgradeScreen = ({
  ...
  // If paid, show feature list only — no trial/upgrade buttons
  if (isPaid) {
    return (
      <div className="min-h-screen bg-background safe-top safe-bottom">
        <div className="sticky top-0 z-10 bg-background/80 backdrop-blur-lg border-b border-border">
          <div className="flex items-center gap-3 px-4 py-4">
            ...
            <h1 className="font-display font-bold text-xl">Freemium Features</h1>
          </div>
        </div>
        <ScrollArea className="h-[calc(100vh-80px)]">
          <div className="p-5 space-y-6 pb-16">
            <div className="text-center py-6">
              ...
              <h2 className="font-display font-bold text-2xl mb-2">You're a Freemium Member!</h2>
            ...
            <Card className="p-4 rounded-2xl bg-emerald-500/10 border-emerald-500/20">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-semibold text-emerald-600 dark:text-emerald-400">Freemium Unlocked</p>
                  <p className="text-sm text-muted-foreground">Lifetime access granted</p>
                </div>
              </div>
            </Card>
  ...
  // Non-paid view: show upgrade options
  return (
    <div className="min-h-screen bg-background safe-top safe-bottom">
      <div className="sticky top-0 z-10 bg-background/80 backdrop-blur-lg border-b border-border">
        <div className="flex items-center gap-3 px-4 py-4">
      ...
      <ScrollArea className="h-[calc(100vh-80px)]">
        <div className="p-5 space-y-6 pb-32">
          ...
          <div className="text-center py-6">
            ...
            <h2 className="font-display font-bold text-2xl mb-2">Unlock Full Potential</h2>
            <p className="text-muted-foreground max-w-sm mx-auto">
          ...
          {isTrialActive && (
            <Card className="p-4 rounded-2xl bg-emerald-500/10 border-emerald-500/20">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-semibold text-emerald-600 dark:text-emerald-400">Trial Active</p>
      ...
      {/* Bottom Action — always clickable for non-purchasers */}
